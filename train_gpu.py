...
from gpu_utils import assign_to_gpu, average_grads_and_varss
...
def train(n_token, cutoffs, ps_device):
    ...
    if len(tower_losses) > 1:
        ...
        # print(tower_grads_and_vars,"----------------------------------------")
        grads_and_vars = average_grads_and_varss(tower_grads_and_vars)
        # grads_and_vars = average_grads_and_vars(loss)
